...
class Classification():
    ...
    def __init__(self,model_type,x_train,x_val,y_train,y_val):
        ...
        if self.model_type == 'Logistic Regression':
            self.technique = LogisticRegression()
        elif self.model_type == 'Decision Tree':
            self.technique = DecisionTreeClassifier(random_state=0)
        elif self.model_type == 'Random Forest':
            self.technique = RandomForestClassifier(n_estimators=10,random_state=0)
